---
title: "Discogs Randomizer"
subtitle: "Don't know what to listen to? Let the randomizer decide for you!"
date: "2026-02-20"
format: 
  html: 
...
#| echo: false
#| output: false
ojs_define(DISCOGS_API_TOKEN = Sys.getenv("DISCOGS_API_TOKEN"))
```
