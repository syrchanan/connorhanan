...
Last time, we left off with our second truth table exploring Church Numerals and some incrementing mathematical operations. If you missed it, [catch up here](../../posts/20250520-lambda-calculus/index.llms.md) before moving on to this post’s topic: data structures and some new mathematical operations. [^1]
